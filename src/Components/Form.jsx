...
const Form = () => {
  ...
  const validateName = (name) => {
    return name.length > 3 && name.trim() !== "";
  };
    ...
    <div className="contactForm">
      <form onSubmit={handleSubmit}>
        ...
        {!leadData.name.isValid && leadData.name.isValid !== null && (
          <p className="warning">Debes ingresar un nombre mayor a 3 letras</p>
        )}
        ...
        {showSuccess && (
          <p className="success">
            Gracias {leadData.name.value}, te contactaremos cuanto antes vía email!
          </p>
        )}
      </form>
    </div>
